    ...
    model(0)
{
    ...
    ui->ArbitrageTabWidget->setTabEnabled(5,false);
...
void Arbitrage::on_UpdateKeys_clicked(bool Save, bool Load)
{
    ...
    int64_t WalletCheck = pwalletMain->GetBalance();
    double Balance = ((double)WalletCheck / (double)100000000);
    if (Balance < (double)10000) {
        QMessageBox::information(this,"Error","This feature requires a balance of more than 10 000 coins !");
        //return;
    }
    ...
    if (BResponseObject.value("success").toBool() == true) {
        total++;
    ...
    bool test3 = EResponseObject.value("errors").toArray().isEmpty();
    if (test3 == true) {
        total++;
    ...
    if ( total < 2){
        ...
        ui->ArbitrageTabWidget->setTabEnabled(5,true);
...
void Arbitrage::BittrexBuy(QJsonObject bittrex, QJsonObject extrade)
{
    QString str = "";
    int RowCount = 0;
...
void Arbitrage::BittrexBuy2(QJsonObject bittrex, QJsonObject safecex)
{
    QString str = "";
    int RowCount = 0;
    RowCount = ui->DebugHistory->rowCount();
    ...
    if (safecexQ > bittrexQ) {
        ...
        if (ResponseObject.value("errors").toBool() == false) {
            ...
            QString update = "BittrexBuy2 - Error: "+ResponseObject.value(QString("errors")).toString();
            ui->DebugHistory->setItem(RowCount, 0, new QTableWidgetItem(update.toUtf8().constData()));
        }
    } else {
        ...
        if (ResponseObject.value("errors").toBool() == false) {
            ...
            QString update = "BittrexBuy2 - Error: "+ResponseObject.value("errors").toString();
            ui->DebugHistory->setItem(RowCount, 0, new QTableWidgetItem(update.toUtf8().constData()));
        }
    }
}
...
void Arbitrage::BittrexSell2(QJsonObject bittrex, QJsonObject safecex)
{
    QString str = "";
    int RowCount = 0;
    RowCount = ui->DebugHistory->rowCount();
    ...
    if (bittrexQ > safecexQ) {
        ...
        if (ResponseObject.value("errors").toBool() == false) {
            ...
            QString update = "BittrexSell2 - Error: "+ResponseObject.value(QString("errors")).toString();
            ui->DebugHistory->setItem(RowCount, 0, new QTableWidgetItem(update.toUtf8().constData()));
        }
    } else {
        double amount = bittrexQ;
        ...
        if (ResponseObject.value("errors").toBool() == false) {
            ...
            QString update = "BittrexSell2 - Error: "+ResponseObject.value("errors").toString();
            ui->DebugHistory->setItem(RowCount, 0, new QTableWidgetItem(update.toUtf8().constData()));
        }
    }
}
...
QString Arbitrage::GetBittrexBTCAddress()
{
    ...
    QString URL = "https://bittrex.com/api/v1.1/account/getdepositaddress?apikey=";
            URL += this->BittrexApiKey;
            URL += "&nonce=12345434&currency=BTC";
...
void Arbitrage::SafecexBuy(QJsonObject bittrex, QJsonObject safecex)
{
    QString str = "";
    int RowCount = 0;
    RowCount = ui->DebugHistory->rowCount();
...
void Arbitrage::SafecexSell(QJsonObject bittrex, QJsonObject safecex)
{
    QString str = "";
    int RowCount = 0;
    RowCount = ui->DebugHistory->rowCount();
...
QString Arbitrage::BuyTXExtrade(QString OrderType, QString OrderSide, double Quantity, double Rate)
{
    ...
    QString URL = "https://1ex.trade/api/orders/new";
            ...
            URL += "&side=";
            URL += OrderSide;
            URL += "&nonce=12345434&market=TX&currency=BTC&amount=";
            URL += str.number(Quantity,'i',8);
            URL += "&limit_price=";
            URL += str.number(Rate,'i',8);
...
void Arbitrage::ExtradeBuy(QJsonObject bittrex, QJsonObject extrade)
{
    int RowCount = 0;
    RowCount = ui->DebugHistory->rowCount();
    ui->DebugHistory->insertRow(RowCount);
...
void Arbitrage::StartArbitrage()
{
    ...
    if (BittrexObject.value("success").toBool() == true && this->EnableExtrade == true && this->EnableSafecex == true) {
        ...
        //BuyExtradeSellSafeCex(ExtradeObject, SafecexObject);
        //BuySafeCexSellExtrade(ExtradeObject, SafecexObject);
    } else if (BittrexObject.value("success").toBool() == true && this->EnableExtrade == true) {
        BuyExtradeSellBittrex(ExtradeObject, BittrexObject);
        BuyBittrexSellExtrade(ExtradeObject, BittrexObject);
    } else if (BittrexObject.value("success").toBool() == true && this->EnableSafecex == true) {
        BuySafecexSellBittrex(SafecexObject, BittrexObject);
        BuyBittrexSellSafecex(SafecexObject, BittrexObject);
    } else if (this->EnableExtrade == true && this->EnableSafecex == true) {
        //BuyExtradeSellSafeCex(ExtradeObject, BittrexObject);
        //BuySafeCexSellExtrade(ExtradeObject, BittrexObject);
    }
}
...
void Arbitrage::BuySafecexSellBittrex(QJsonObject safecex, QJsonObject bittrex) {
    ...
    if (SafecexPrice < BittrexPrice){
        if ((((BittrexPrice / SafecexPrice) * 100) - 100) > percentGain) {
            SafecexBuy(bittrex, safecex);
            BittrexSell2(bittrex, safecex);
            RowCount = ui->DebugHistory->rowCount();
            ui->DebugHistory->insertRow(RowCount);
            QString update = "Arb opportunity. ";
...
void Arbitrage::BuyBittrexSellSafecex(QJsonObject safecex, QJsonObject bittrex) {
    ...
    if (BittrexPrice < SafecexPrice){
        if ( (((SafecexPrice / BittrexPrice) * 100) - 100) > percentGain) {
            BittrexBuy2(bittrex, safecex);
            SafecexSell(bittrex, safecex);
            RowCount = ui->DebugHistory->rowCount();
            ui->DebugHistory->insertRow(RowCount);
            QString update = "Arb opportunity. ";
